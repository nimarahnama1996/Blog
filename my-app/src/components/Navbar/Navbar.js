      ...
      <div className='container w-100'>
        ...
        <div className = "brand-and-toggler">
             <Link to = "/" className='navbar-brand text-white flex align-center fs-26'>
                 ...
                 <span className='navbar-brand-txt font-rubik fw-5'>
                  Blog.
                 </span>
              </Link>
        </div>
        ...
        <div className='navbar-row flex align-center'>
          <ul className = "navbar-nav flex align-center font-rubik">
            ...
            <li className='nav-item'>
               <Link to = "/blog" className='nav-link text-white fw-4 fs-19'>
                Blog
               </Link>
             </li>
              <li className='nav-item'>
                  <Link to = "/about" className='nav-link text-white fw-4 fs-19'>
                    About
                  </Link>
              </li>
          </ul>
